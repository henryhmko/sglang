...
# TODO: Added SGLANG stuff - delete comment once done
...
# TODO: below are remaining stuff from vllm that i couldn't find replacements for
...
class Phi3SmallSelfAttention(nn.Module):
    ...
    def __init__(
        ...
        # NOTE: below is vllm implementation
        ...
        # TODO: Change rope to sglang style(getattr(config....)
        ...
        # NOTE: FIXED TO RADIDX ATTENTION
        ...
        # NOTE: below is old vllm attn - delete once done
        # self.attn = Attention(
        #     self.num_heads_per_partition,
        #     self.head_dim,
        #     self.scale,
    ...
    #            Optional[Tuple[torch.Tensor]]]:
        ...
        attn_output = self.attn(q, k, v, kv_cache, forward_batch)
...
class Phi3SmallForCausalLM(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # NOTE: logits_processor is changed - delete
    ...
    # NOTE: deleted compute_logits from vllm
    # def compute_logits(
    #     self,
    #     hidden_states: torch.Tensor,
    ...
    # NOTE: delete line below
        ...
        return self.logits_processor(
            input_ids, output_hidden_states, self.lm_head.weight, forward_batch
        )
        # NOTE: why is it reassigning the same thing??? delete
        # output_hidden_states = output_hidden_states
        # return output_hidden_states


    # NOTE: is this func needed????
